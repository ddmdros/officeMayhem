export const CLASS_ICONS: Record<string, string> = {
  "Damage Dealer": "https://media.ffycdn.net/eu/supercell/gLVTV9eKK199gwE7RJMY.png?width=2400",
  "Tank": "https://media.ffycdn.net/eu/supercell/tku8ZjA6AtybsHsaPb5t.png?width=2400",
  "Assassin": "https://media.ffycdn.net/eu/supercell/q68V3YMWEizA9pfrTGSS.png?width=2400",
  "Support": "https://media.ffycdn.net/eu/supercell/9YhEFJcTqxngqMtnySHJ.png?width=2400",
  "Marksman": "https://media.ffycdn.net/eu/supercell/84NvDD32VU2aQttYiHgC.png?width=2400",
  "Controller": "https://media.ffycdn.net/eu/supercell/WjjpYf3ooK53AwVo4fuR.png?width=2400",
  "Artillery": "https://media.ffycdn.net/eu/supercell/7nihqerPBNTxcAo4vxZW.png?width=2400",
};
...
export const RARITY_COLORS: Record<string, string> = {
    ...
    "Mythic": "#d64e52",
    "Legendary": "#fecb00",
    "Ultra Legendary": "#ff4747"
};

export const MINA_IMAGES = {
